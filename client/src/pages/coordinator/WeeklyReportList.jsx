...
const ViewReport = lazy(()=> import('../../components/StudentWeeklyReport/CoordinatorViewReport'))
const ReportRequest = lazy(()=> import('../../components/StudentWeeklyReport/ReportRequest_coordinator'))
