...
const CoordinatorInfo = () => {
  ...
  const { data, isLoading, isError } = useQuery(["getDirector"], getDirector);

  const { mutate: editText } = useMutation(editDirectorProfile, {
    onSuccess: () => {
      Swal.fire("Success", "Update Successful", "success");
      queryClient.invalidateQueries("getDirector");
      setEditable(false);
    },
    onError: () => {
      Swal.fire(
  ...
  const { mutate: editProfile } = useMutation(updateDirectorProfilePicture, {
    onSuccess: () => {
      Swal.fire("Success", "Update Successful", "success");
      queryClient.invalidateQueries("getDirector");
      setEditable(false);
