...
const Announcement = () => {
  ...
  const { data: getDirectorInfo, isLoading: directorLoading } = useQuery({
    queryKey: ["director"],
    queryFn: getDirector,
  });

  const announcementList = getAnnouncementList ? getAnnouncementList : [];
  const directorName = `${getDirectorInfo?.firstname} ${getDirectorInfo?.lastname}`;
  ...
  const handleSubmit = (event) => {
    ...
    mutate({
      ...
      createdBy: directorName,
      createdRole: getDirectorInfo?.user?.role,
    });
  };
                  ...
                  >
                    ...
                    <div>
                      <MultiSelect
                        ...
                        data={["Student", "Trainer", "Teacher", "coordinator"]}
                        hidePickedOptions
