...
const CoordinatorInfo = () => {
  ...
  const { mutate: editText } = useMutation(editSuperAdminProfile, {
    onSuccess: () => {
      Swal.fire("Success", "Update Successful", "success");
      queryClient.invalidateQueries("getSuperadminInfo");
      setEditable(false);
    },
    onError: () => {
      Swal.fire(
  ...
  const { mutate: editProfile } = useMutation(updateSuperAdminProfilePicture, {
    onSuccess: () => {
      Swal.fire("Success", "Update Successful", "success");
      queryClient.invalidateQueries("getSuperadminInfo");
      setEditable(false);
