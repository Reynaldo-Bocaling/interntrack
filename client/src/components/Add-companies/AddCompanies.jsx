            ...
            <>
              ...
              <ModalBody>
                <form
                  ...
                  className="flex flex-col md:flex-row items-start gap-5 px-3 py-5"
                >
                  <div className="md:border-r md:pr-12 md:mr-5 w-full md:w-[350px] flex flex-col gap-5">
                    <span className="font-medium text-lg">Company Info</span>
                    <Input
                      type="text"
                      label="Company Name "
                      onChange={(e) => setCompanyName(e.target.value)}
                    ...
                    <Tooltip content="Browse PDF file" closeDelay={0}>
                      <button className=" uploadMoa   relative overflow-hidden text-sm  w-full flex flex-col items-center justify-center gap-2">
                        {Moa ? (
                          <BiCheck
                            size={30}
                            className="addCompanyCheck text-green-500"
                          />
                        ) : (
                          <AiOutlineCloudUpload
                            size={30}
                            className=" addCompanyCheck text-[#7057fc]"
                          />
                        )}
                  ...
                  <div>
                    ...
                    <div className="flex flex-col gap-4 mt-5">{fields}</div>
